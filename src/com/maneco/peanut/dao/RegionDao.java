...
public class RegionDao {
	...
	private static void testRemoveAreaExt() {
		System.out.println(RegionDao.removeAreaExt("台前县"));
		System.out.println(RegionDao.removeAreaExt("天台区"));
		System.out.println(RegionDao.removeAreaExt("市辖区"));
		System.out.println(RegionDao.removeAreaExt("辛集市"));
		System.out.println(RegionDao.removeAreaExt("青龙满族自治区"));
	}
